...
$kulanicisor=$db->prepare("SELECT * FROM kullanici where kullanici_mail=:mail");
...
if($say==0 or $say>1)
{
  header("location:../production/login.php?izinsiz");
          ...
          <div class="left_col scroll-view">
            ...
            <div class="profile clearfix">
              ...
              <div class="profile_info">
                <span>Hoşgeldin,</span>
                <h2><?echo $kullanicicek['kullanici_adsoyad'];  ?></h2>
              </div>
            </div>
            <!-- /menu profile quick info -->
            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                    ...
                    <li><a href="menuayar.php"><i class="fa fa-user"></i> Menu  </a></li>
                  <li><a><i class="fa fa-cogs"></i> Ayarlar <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="genel-ayar.php">Genel Ayarlar</a></li>
                      <li><a href="sliderayarlar.php">Slider Ayarları</a></li>
              ...
              <ul class="nav navbar-nav navbar-right">
                <li class="">
                  <a href="javascript:;" class="user-profile dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                    <img src="images/img.jpg" alt=""><?echo $kullanicicek['kullanici_adsoyad'];  ?>
