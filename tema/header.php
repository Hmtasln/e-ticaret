...
include '../nadmin/netting/function.php';
...
<html lang="en">
  <head>
    ...
    <meta name="description" content=<? echo $ayarcek['ayar_description']; ?>>
  	<meta name="keywords" content=<? echo $ayarcek['ayar_keywords']; ?>>
  	<meta name="author" content=<? echo $ayarcek['ayar_author']; ?>>
  	    <title><? echo $ayarcek['ayar_title']; ?></title>
				...
				<div class="row">
					<div class="col-md-10">
						...
						<div class="navbar-collapse collapse">
							<? $menusor=$db->prepare("SELECT * FROM menu where menu_durum='1' ");
							$menusor->execute();
							...
							<ul class="nav navbar-nav">
								...
								<?while($menucek=$menusor->fetch(PDO::FETCH_ASSOC)){?>
												<li>
													<a href="<? $menucek['farkli_url'] ? print $menucek['farkli_url'] :  print'sayfa-'.$menucek["menu_url"].'-'.$menucek['meu_id'];?> <?  ?>"><?=$menucek['menu_ad']?></a></li>
												<?}?>
									...
									<ul class="dropdown-menu megamenu container row">
										<li class="col-sm-4">
											...
											<ul>
												...
												<?while($menucek=$menusor->fetch(PDO::FETCH_ASSOC)){?>
												<li><a href="<?=$menucek['menu_url']?>"><?=$menucek['menu_ad']?></a></li>
												<?}?>
										...
										<li class="col-sm-4">
											...
											<ul>
												<li><a href="index-1.htm">Home Page</a></li>
												<?while($menucek=$menusor->fetch(PDO::FETCH_ASSOC)){?>
												<li><a href="<?=$menucek['menu_url']?>"><?print$menucek['menu_ad']?></a></li>
												<?}?>
										...
										<li class="col-sm-4">
											...
											<ul>
												<li><a href="index-1.htm">Home Page</a></li>
												<?while($menucek=$menusor->fetch(PDO::FETCH_ASSOC)){?>
												<li><a href="<?$menucek['farkli_url'] ?  $menucek['farkli_url'] : $menucek['menu_url']?>"><?print $menucek['menu_ad'];?></a></li>
												<?}?>
