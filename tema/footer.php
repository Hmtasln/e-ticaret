			...
			<div class="row">
				...
				<div class="col-md-4"><!--footer contact widget-->
					...
					<ul class="contact-widget">
						<li class="fphone"><? echo $ayarcek['ayar_tel']; ?><br><? echo $ayarcek['ayar_faks']; ?> </li>
						<li class="fmobile"><? echo $ayarcek['ayar_gsm']; ?></li>
						<li class="fmail lastone"><? echo $ayarcek['ayar_mail']; ?></li>
					</ul>
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-md-3"><!--footer Share-->
					...
					<div class="fsoc">
						<a href="<? echo $ayarcek['ayar_twitter']; ?>" class="ftwitter">twitter</a>
						<a href="<? echo $ayarcek['ayar_facebook']; ?>" class="ffacebook">facebook</a>
